...
async def scrape_lever_jobs(company_slug: str):
...
async def scrape_all_lever_jobs():
    ...
    with open(csv_path, "r") as f:
        ...
        for row in reader:
            ...
            data, num_jobs = await scrape_lever_jobs(company_slug)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        asyncio.run(scrape_all_lever_jobs())
    else:
        asyncio.run(scrape_lever_jobs(sys.argv[1]))
